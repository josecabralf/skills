...
description: Write text for humans other than the user. Use when reviewing documentation, code comments, or explanations that will be read by people other than the user in the session.
---
